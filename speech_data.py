...
DATA_DIR = 'data/'
pcm_path = "./sounds/" # 8 bit
wav_path = "./sounds/" # 16 bit s16le
path = pcm_path
CHUNK = 4096
...
def maybe_download(file, work_directory):
  ...
  if not os.path.exists(filepath):
    if not file.startswith("http"): url_filename = "https://www.dropbox.com/s/5f2u5sn4b5r30uy/Archive.zip?dl=0"
...
if __name__ == "__main__":  
  ...
  maybe_download(work_directory="sounds/")